...
- UE switches passed via `-- <args>` come from `reference/unreal-args.md`, never invented.

## Working tree vs install location
The skill is authored in this working tree (`E:\Work\ushell-skill\`). Install to `~/.claude/skills/ushell/` only after 7/7 GREEN passes.
